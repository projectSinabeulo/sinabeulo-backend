...
public class ttsStartService {
    ...
    //basic Sample
    public static void quickSample1() {
...
//            }
    ...
    //return Stream
    public static ResponseEntity<InputStreamResource> quickSample2() {
        /** Demonstrates using the Text-to-Speech API. */
        // Instantiates a client
        try (TextToSpeechClient textToSpeechClient = TextToSpeechClient.create()) {
            // Set the text input to be synthesized
...
//                            .setSsmlGender(SsmlVoiceGender.NEUTRAL)
            ...
            try (InputStream inputStream = new ByteArrayInputStream(audioContents.toByteArray());) {
                ...
                // Set the appropriate media type for your stream data
                MediaType mediaType = MediaType.APPLICATION_OCTET_STREAM;

                // Create an InputStreamResource from the stream data
                InputStreamResource inputStreamResource = new InputStreamResource(inputStream);

//                System.out.print(inputStreamResource);       //check..가 안되네
